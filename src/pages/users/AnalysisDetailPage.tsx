      ...
      <div className="flex-1 overflow-y-auto px-6 py-8 space-y-8">
        ...
        <div className="flex flex-col items-center space-y-4">
          <div className="relative">
            ...
            <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 flex items-center justify-center text-center bg-black text-white text-[10px] font-black px-4 py-1 rounded-full uppercase tracking-widest border-2 border-[#C68E2D]">
