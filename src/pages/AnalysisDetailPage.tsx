...
const AnalysisDetailPage: React.FC = () => {
  ...
  // Ambil data dari global store berdasarkan ID
  const analysisData = useAnalysisStore((state) => state.getAnalysisById(id || '1'));
        ...
        <div className="flex-1 flex items-center justify-center px-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">
              Data analisis dengan ID {id} tidak ada
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="px-6 py-6 space-y-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-md">
            ...
            <div className="text-base font-semibold text-gray-800">
              {new Date(analysisData.eventDate).toLocaleDateString('id-ID', {
                day: '2-digit',
                month: 'long',
                year: 'numeric',
              })}
